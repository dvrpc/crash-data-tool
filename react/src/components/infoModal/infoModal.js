    ...
    render() {
        return (
            <div className="no-print">
                <button id="crash-map-nav-info-btn" className="hover-btn" type="button" onClick={this.showModal}>info</button>
                <div role="dialog" id="crash-map-modal" aria-modal="true" aria-labelledby="crash-map-nav-info-btn" ref={el => this.modal = el}>
                    ...
                    <div id="crash-map-modal-content">
                        ...
                        <ol className="crash-map-modal-category-list">
                            ...
                            <li><details><summary className="crash-map-modal-summary"><strong>Possible Injury</strong></summary> The responding police officer suspects that the person sustained an injury of low severity, sometimes a "complaint of pain," and the injury is not readily evident.</details></li>
                            <li>
                                <details>
                                    <summary className="crash-map-modal-summary"><strong>Not Injured</strong></summary> The responding police officer does not suspect that the person was injuried.
                                    <ul>
                            ...
                            <li><details><summary className="crash-map-modal-summary"><strong>Unknown Injury</strong></summary> An injury is suspected but the severity of the injury is unknown.</details></li>
                            <li><details><summary className="crash-map-modal-summary"><strong>Unknown if Injured</strong></summary> Data is unavailable regarding whether the person was injured.</details></li>
                        </ol>
