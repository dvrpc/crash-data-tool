// NOTE: since this is regular HTML, use class instead of className
const submitForm = e => {
    e.preventDefault()
    console.log('e is ', e)
}
...
const queryModalHTML = () => {
    return `
        <form id="new-crash-query" onSubmit=${submitForm} onEnter=${submitForm}>
            <section class="crash-query-subgroup">
                <div>
                    <p class="crash-query-subheader">Collision Type</p>
                    <div id="query-type">
                ...
                <div>
                    <p class="crash-query-subheader">Crash Severity</p>
                ...
                <div>
                    <p class="crash-query-subheader">Location</p>
...
// <section class="crash-query-subgroup">
//     <div>
//         <p class="crash-query-subheader">Road Conditions</p>
...
//     <div>
//         <p class="crash-query-subheader">Weather</p>
...
//     <div>
//         <p class="crash-query-subheader">Illumination</p>
...
// <section class="crash-query-subgroup">
//     <div>
//         <p class="crash-query-subheader">Month</p>
//         <div id="query-month">
...
//     <div>
//         <p class="crash-query-subheader">Year</p>
//         <div id="query-year">
//             <select>
...
//     <div>
//         <p class="crash-query-subheader">Day of Week</p>
//         <div id="query-day">
...
// <section class="crash-query-subgroup">
//     <div>
//         <p class="crash-query-subheader">Vehicle Type</p>
